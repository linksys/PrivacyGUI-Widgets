...
class AppImagesData extends Equatable {
  ...
  factory AppImagesData.dark() => AppImagesData(
        ledRedSolid: exactAssetPicture('assets/images/led_red_solid.svg',
            package: 'privacygui_widgets'),
        openDns: const AssetImage('assets/images/open_dns.png',
            package: 'privacygui_widgets'),
        modemIdentifying: exactAssetPicture(
            'assets/images/modem_identifying.svg',
            package: 'privacygui_widgets'),
        imgRouterBlack: exactAssetPicture('assets/images/img_router_black.svg',
            package: 'privacygui_widgets'),
        ledBlueBlink: exactAssetPicture('assets/images/led_blue_blink.svg',
            package: 'privacygui_widgets'),
        imgMoveNodes: exactAssetPicture('assets/images/img_move_nodes.svg',
            package: 'privacygui_widgets',
            filter: const {"#ff000000": "#ffffffff"}),
        internetToDevice: exactAssetPicture(
            'assets/images/internet_to_device.svg',
            package: 'privacygui_widgets',
            filter: const {"#FFD9D9D9": "#ffffffff", "#FF44474F": "#ffffffff"}),
        tempIllustration: const AssetImage(
            'assets/images/temp_illustration.png',
            package: 'privacygui_widgets'),
        linksysWordmark: exactAssetPicture('assets/images/linksys_wordmark.svg',
            package: 'privacygui_widgets'),
        internetToRouter: exactAssetPicture(
            'assets/images/internet_to_router.svg',
            package: 'privacygui_widgets',
            filter: const {"#FFD9D9D9": "#ffffffff", "#FF44474F": "#ffffffff"}),
        ledWhiteSolid: exactAssetPicture('assets/images/led_white_solid.svg',
            package: 'privacygui_widgets'),
        brandTinder: const AssetImage('assets/images/brand_tinder.png',
            package: 'privacygui_widgets'),
        ledPurpleSolid: exactAssetPicture('assets/images/led_purple_solid.svg',
            package: 'privacygui_widgets'),
        signalGood: const AssetImage('assets/images/signal_good.png',
            package: 'privacygui_widgets'),
        ledYellowSolid: exactAssetPicture('assets/images/led_yellow_solid.svg',
            package: 'privacygui_widgets'),
        ledRedBlink: exactAssetPicture('assets/images/led_red_blink.svg',
            package: 'privacygui_widgets'),
        iconEllipse: const AssetImage('assets/images/icon_ellipse.png',
            package: 'privacygui_widgets'),
        modemPlugged: exactAssetPicture('assets/images/modem_plugged.svg',
            package: 'privacygui_widgets'),
        noInternetConnection: exactAssetPicture(
            'assets/images/no_internet_connection.svg',
            package: 'privacygui_widgets'),
        fortinetDns: const AssetImage('assets/images/fortinet_dns.png',
            package: 'privacygui_widgets'),
        imgRouterWhite: exactAssetPicture('assets/images/img_router_white.svg',
            package: 'privacygui_widgets'),
        ledBlueSolid: exactAssetPicture('assets/images/led_blue_solid.svg',
            package: 'privacygui_widgets'),
        imgAddNodes: exactAssetPicture('assets/images/img_add_nodes.svg',
            package: 'privacygui_widgets',
            filter: const {"#ff231F20": "#fff3f3f3", "#ff000000": "#ffffffff"}),
        linksysLogoBlack: exactAssetPicture(
            'assets/images/linksys_logo_black.svg',
            package: 'privacygui_widgets',
            filter: const {"#ff000000": "#ffffffff"}),
        deviceLaptop: const AssetImage('assets/images/device_laptop.png',
            package: 'privacygui_widgets'),
        deviceSmartPhone: const AssetImage(
            'assets/images/device_smart_phone.png',
            package: 'privacygui_widgets'),
        modemWaiting: exactAssetPicture('assets/images/modem_waiting.svg',
            package: 'privacygui_widgets'),
        signalExcellent: const AssetImage('assets/images/signal_excellent.png',
            package: 'privacygui_widgets'),
        pnpFinishDesktop: exactAssetPicture(
            'assets/images/pnp_finish_desktop.svg',
            package: 'privacygui_widgets'),
        ledWhiteBlink: exactAssetPicture('assets/images/led_white_blink.svg',
            package: 'privacygui_widgets'),
        speedtestPowered: const AssetImage(
            'assets/images/speedtest_powered.png',
            package: 'privacygui_widgets'),
        ledPurpleBlink: exactAssetPicture('assets/images/led_purple_blink.svg',
            package: 'privacygui_widgets'),
        iconEllipseGreen: const AssetImage(
            'assets/images/icon_ellipse_green.png',
            package: 'privacygui_widgets'),
        devices: AppDevicesData.dark(),
        modemDevice: exactAssetPicture('assets/images/modem_device.svg',
            package: 'privacygui_widgets'),
      );
  factory AppImagesData.light() => AppImagesData(
        ...
        linksysWordmark: exactAssetPicture('assets/images/linksys_wordmark.svg',
            package: 'privacygui_widgets',
            filter: const {"#ffffffff": "#ff000000"}),
        internetToRouter: exactAssetPicture(
            'assets/images/internet_to_router.svg',
            package: 'privacygui_widgets'),
        ledWhiteSolid: exactAssetPicture('assets/images/led_white_solid.svg',
  ...
  final AppDevicesData devices;
  final SvgLoader modemDevice;
