...
required this.routerMr6350,
    ...
    factory AppDevicesData.dark() => const AppDevicesData(
      routerWhw01: AssetImage('assets/images/devices/router-whw01.png', package: 'linksys_widgets'),
routerWhw03: AssetImage('assets/images/devices/router-whw03.png', package: 'linksys_widgets'),
routerMr7350: AssetImage('assets/images/devices/router-mr7350.png', package: 'linksys_widgets'),
routerEa8300: AssetImage('assets/images/devices/router-ea8300.png', package: 'linksys_widgets'),
routerMx6200: AssetImage('assets/images/devices/router-mx6200.png', package: 'linksys_widgets'),
routerWhw03b: AssetImage('assets/images/devices/router-whw03b.png', package: 'linksys_widgets'),
routerEa9350: AssetImage('assets/images/devices/router-ea9350.png', package: 'linksys_widgets'),
routerLn12: AssetImage('assets/images/devices/router-ln12.png', package: 'linksys_widgets'),
routerWhw01p: AssetImage('assets/images/devices/router-whw01p.png', package: 'linksys_widgets'),
routerLn11: AssetImage('assets/images/devices/router-ln11.png', package: 'linksys_widgets'),
routerMx5300: AssetImage('assets/images/devices/router-mx5300.png', package: 'linksys_widgets'),
routerWhw01b: AssetImage('assets/images/devices/router-whw01b.png', package: 'linksys_widgets'),
routerMr7500: AssetImage('assets/images/devices/router-mr7500.png', package: 'linksys_widgets'),
routerMr6350: AssetImage('assets/images/devices/router-mr6350.png', package: 'linksys_widgets'),
