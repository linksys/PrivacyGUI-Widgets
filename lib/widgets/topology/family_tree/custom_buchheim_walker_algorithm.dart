...
class CustomBuchheimWalkerAlgorithm extends Algorithm {
  ...
  moveToCenter(Graph graph) {
    ...
    final viewCenterX = viewWidth / 2;
    final root = graph.getNodeAtPosition(0);
    final rootCenterX = root.x + (root.width / 2);
    final graphSize = calculateGraphSize(graph);
    final graphCenterX = graphSize.width / 2;
    final centerX = graphCenterX > viewCenterX ? graphCenterX : viewCenterX;
    _shiftX = centerX - rootCenterX;
  }
